...
public class LightSailN1V1 extends LightSailVideo {
    ...
    public LightSailN1V1() {
        super("images/video1.png", "Bienvenue dans cette vidéo expliquant le phishing. Le phishing est une technique de cybercriminalité très courante, utilisée pour voler des informations personnelles et financières. Dans cette vidéo, nous allons aborder les trois principales catégories de phishing, et comment les reconnaître pour éviter de devenir une victime.\n" +
                "\n" +
